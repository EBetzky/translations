...
class TranslationRouter {
    ...
    private initializeRoutes() {
         ...
         *             type: number
         *             format: int64
         *             example: [1617180000000, 1617190000000, 1617200000000]
         *
         * ### HTTP operations
         * /translations/search/:
         *   get:
         ...
         *           Please note - lack of search results ends up with an empty array.
         *         content:
         *           application/json:
         *             schema:
         *               type: array
         ...
         *   get:
         *     summary: Get a translation by Elasticsearch ID
         ...
         *           Please note - search with no result will return an empty array.
         *         content:
         *           application/json:
         *             schema:
         *               type: array
         ...
         *       - name: translationId
         *         in: path
         *         description: Elasticsearch ID of the Translation to update
         *         required: true
         *         schema:
         *           type: string
         *     requestBody:
         ...
         * /translations/{translationId}:
         *   delete:
         *     summary: Delete a translation by Elasticsearch ID
         ...
         *       - name: translationId
         *         in: path
         *         description: Elasticsearch ID of the translation to delete
         *         required: true
         *         schema:
         *           type: string
         *     responses:
