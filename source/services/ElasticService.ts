...
export class ElasticService {
    ...
    public async initializeIndex(index: string, mappings: MappingTypeMapping): Promise<boolean> {
        let created = false;
        try {
    ...
    public async indexDocument(index: string, document: unknown) {
        try {
    ...
    public async updateDocument(index: string, id: string, document: unknown) {
        try {
    ...
    public async searchDocuments(index: string, query: QueryDslQueryContainer, page: number = 0) {
        try {
